    ...
    <section className="g-section" id="agences">
      <div className="container g-head">
        ...
        <p className="lead">
          ...
          au plus près des grands pôles industriels français. Survolez la carte
          pour découvrir chaque implantation.
        </p>
      </div>
      ...
      <div className="g-stage">
        <div className="g-map">
          ...
          <div className="g-map-legend">
            ...
            <span>6 agences · Up Technologies</span>
          </div>
        </div>
        ...
        <aside className="g-aside">
          ...
          <div className="g-detail" key={hover}>
            <div className="g-detail-img">
              <img src={agencyPhotos[hover]} alt={`Agence ${a.ville}`}/>
              <span className="g-detail-num">N°{String(hover + 1).padStart(2, '0')}</span>
              <span className="g-detail-coord">
                {formatCoord(a.lat, 'N', 'S')} · {formatCoord(a.lng, 'E', 'O')}
              </span>
            </div>
            <h3 className="g-detail-city">{a.ville}</h3>
            <div className="g-detail-meta">
              ...
              <div>
                ...
                <strong>{a.cp} · {a.pays}</strong>
              </div>
              <div>
                <span>Ouverture</span>
                <strong>{a.founded} <em>· {yearsActive} ans</em></strong>
              </div>
            </div>
          </div>
        </aside>
